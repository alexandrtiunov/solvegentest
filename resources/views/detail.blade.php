...
@section('content')
    <div class="col-md-9 det">
        ...
        <div class="single-bottom1">
            <h6>Details</h6>
            <p class="prod-desc">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
                ...
                augue duis dolore te feugait nulla facilisi. Nam liber tempor cum soluta nobis eleifend option</p>
        </div>
            ...
            <div class="product">
                <div class="product-desc">
                    ...
                    <div class="prod1-desc">
                        ...
                        <p class="product_descr"> Vivamus ante lorem, eleifend nec interdum non, ullamcorper et arcu.
