...
<div class="container">
    ...
    <form method="post" action="{{action('Admin\ProductController@update', $product['id'])}}" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-4"></div>
            <div class="form-group col-md-4">
                <label for="short_name">Модель:</label>
        ...
        <div class="row">
            <div class="col-md-4"></div>
            <div class="form-group col-md-4">
                <label for="content">Производитель:</label>
                <input rows="20" cols="45" class="form-control" name="manufacturer" value="{{$product->manufacturer}}">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4"></div>
            <div class="form-group col-md-4">
                <label for="short_discription">Описание:</label>
                <textarea type="text" class="form-control" name="discription" style="height: 200px;">{{$product->discription}}</textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4"></div>
            <div class="form-group col-md-4">
                ...
                <img src="/images/product-foto-main/{{$product->img_path}}">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4"></div>
            <div class="form-group col-md-4">
                <label for="img_path">Категория:</label>
        ...
        <div class="row">
            <div class="col-md-4"></div>
            <div class="form-group col-md-4">
                <button type="submit" class="btn btn" style="margin-left:0px">Сохранить изменения</button>
